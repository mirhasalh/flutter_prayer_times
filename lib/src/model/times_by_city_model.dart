// This class is generated using https://javiercbk.github.io/json_to_dart/

class TimesByCityModel {
  int? code;
  String? status;
  Data? data;

  TimesByCityModel({this.code, this.status, this.data});

  TimesByCityModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Method {
  ...
  Method({this.id, this.name, this.location});
